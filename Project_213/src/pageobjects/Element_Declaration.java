...
public class Element_Declaration
{
	...
	//It may leads to StaleElementReferenceException
	...
	//All criterias should match  [@FIndBys alternative]
	@FindBy(xpath="//select &&  input[@type='text']")
	public List<WebElement> DropdownAndTextBoxlist1;
	
	//At least one criteria should match..  [@FIndAll alternative]
	@FindBy(xpath="//select ||  input[@type='text']")
	public List<WebElement> DropdownAndTextBoxlist2;
